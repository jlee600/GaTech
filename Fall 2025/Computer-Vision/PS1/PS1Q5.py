...
class Prob5():
    ...
    def my_conv2d(self, image, filter):
        ...
        for i in range(3):
            convolved_image[..., i] = convolve(image[..., i], filter)
        convolved_image = np.clip(convolved_image, 0.0, 1.0)
        ###### END CODE HERE ######
    ...
    def prob_5_1(self):
        ...
        titles = ['Identity', 'Blur', 'Sobel (x)', 'Laplacian']
        imgs   = [identity_image, blur_image, sobel_image, laplacian_image]
    ...
    def create_hybrid_image(self, image1, image2):
        ...
        hybrid_image = None
        ###### START CODE HERE ######
        low1 = self.my_conv2d(image1, self.gaussian_filter)
        low2 = self.my_conv2d(image2, self.gaussian_filter)
        high2 = image2 - low2
    ...
    def prob_5_2(self):
        ...
        plt.title('Multiscale Hybrid Image')
        plt.axis('off')
        plt.show()
        ##### END CODE HERE ######
